...
export const MIN_FLOAT: Float = Float(MIN_NUMBER)

export type MathContextLikee = MathRangeViolationContext | MathPrecisionViolationContext;
...
export type MathError<T1 extends MathErrorCode> = {
    ...
    context: Option<MathContextLikee>
...
export type FloatRLike<T1 extends MathErrorCode> = Result<Float, MathError<T1>>;

export type FloatRMap<T1 extends NumberLike> =
    T1 extends number    ? FloatRLike<_ArithmeticRangeViolation> :
    T1 extends bigint    ? FloatRLike<_ArithmeticRangeViolation> :
    T1 extends Float     ? Float :
    T1 extends I8        ? Float :
    T1 extends I16       ? Float :
    T1 extends I32       ? Float :
    T1 extends I64       ? FloatRLike<_ArithmeticRangeViolation> :
    T1 extends I128      ? FloatRLike<_ArithmeticRangeViolation> :
    T1 extends I256      ? FloatRLike<_ArithmeticRangeViolation> :
    T1 extends I         ? FloatRLike<_ArithmeticRangeViolation> :
    T1 extends U8        ? Float :
    T1 extends U16       ? Float :
    T1 extends U32       ? Float :
    T1 extends U64       ? FloatRLike<_UpperArithmeticRangeViolation> :
    T1 extends U128      ? FloatRLike<_UpperArithmeticRangeViolation> :
    T1 extends U256      ? FloatRLike<_UpperArithmeticRangeViolation> :
    T1 extends U         ? FloatRLike<_UpperArithmeticRangeViolation> :
    never;
...
export type Float = 
    ...
    add(x: Float): FloatRLike<_UpperArithmeticRangeViolation>;
    sub(x: Float): FloatRLike<_LowerArithmeticRangeViolation>;
    mul(x: Float): FloatRLike<_ArithmeticRangeViolation>;
    div(x: Float): FloatRLike<_ArithmeticRangeViolationAndDivisionByZero>;
};

export function Float<T1 extends NumberLike>(_x: NumberLike): FloatRMap<T1> {
...
export type IRMap<T1 extends ILike<T3>, T2 extends NumberLike, T3 extends ILikeBrand = ILikeBrandMap<T1>> =
    ...
    T1 extends I32
        ...
        : never :
    T1 extends I64
        ? T2 extends number  ? IRLike<I64, _ArithmeticRangeAndPrecisionViolation>
...
export function I8(_x: number): IRMap<I8, number>;
export function I8(_x: bigint): IRMap<I8, bigint>;
export function I8(_x: Float): IRMap<I8, Float>;
export function I8(_x: I8): IRMap<I8, I8>;
export function I8(_x: I16): IRMap<I8, I16>;
export function I8(_x: I32): IRMap<I8, I32>;
export function I8(_x: I64): IRMap<I8, I64>;
export function I8(_x: I128): IRMap<I8, I128>;
export function I8(_x: I256): IRMap<I8, I256>;
export function I8(_x: I): IRMap<I8, I>;
export function I8(_x: U8): IRMap<I8, U8>;
export function I8(_x: U16): IRMap<I8, I16>;
export function I8(_x: U32): IRMap<I8, U32>;
export function I8(_x: U64): IRMap<I8, U64>;
export function I8(_x: U128): IRMap<I8, U128>;
export function I8(_x: U256): IRMap<I8, U256>;
export function I8(_x: U): IRMap<I8, U>;
...
export type URMap<T1 extends ULike<T3>, T2 extends NumberLike, T3 extends ULikeBrand = ULikeBrandMap<T1>> =
    ...
    T1 extends U16
        ...
        : T2 extends U8      ? U8
        : T2 extends U16     ? U16
        : T2 extends U32     ? URLike<U16, _UpperArithmeticRangeViolation>
        : T2 extends U64     ? URLike<U16, _UpperArithmeticRangeViolation>
        : T2 extends U128    ? URLike<U16, _UpperArithmeticRangeViolation>
        : T2 extends U256    ? URLike<U16, _UpperArithmeticRangeViolation>
        : T2 extends U       ? URLike<U16, _UpperArithmeticRangeViolation>
        : never :
    T1 extends U32
        ? T2 extends number  ? URLike<U32, _ArithmeticRangeAndPrecisionViolation>
        : T2 extends bigint  ? URLike<U32, _ArithmeticRangeViolation>
        : T2 extends Float   ? URLike<U32, _ArithmeticRangeAndPrecisionViolation>
        : T2 extends I8      ? URLike<U32, _LowerArithmeticRangeViolation>
        : T2 extends I16     ? URLike<U32, _LowerArithmeticRangeViolation>
        : T2 extends I32     ? URLike<U32, _LowerArithmeticRangeViolation>
        : T2 extends I64     ? URLike<U32, _ArithmeticRangeViolation>
        : T2 extends I128    ? URLike<U32, _ArithmeticRangeViolation>
        : T2 extends I256    ? URLike<U32, _ArithmeticRangeViolation>
        : T2 extends I       ? URLike<U32, _ArithmeticRangeViolation>
        : T2 extends U8      ? U32
        : T2 extends U16     ? U32
        : T2 extends U32     ? U32
        : T2 extends U64     ? URLike<U32, _UpperArithmeticRangeViolation>
        : T2 extends U128    ? URLike<U32, _UpperArithmeticRangeViolation>
        : T2 extends U256    ? URLike<U32, _UpperArithmeticRangeViolation>
        : T2 extends U       ? URLike<U32, _UpperArithmeticRangeViolation>
        : never:
    T1 extends U64
        ? T2 extends number  ? URLike<U64, _ArithmeticRangeAndPrecisionViolation>
        : T2 extends bigint  ? URLike<U64, _ArithmeticRangeViolation>
        : T2 extends Float   ? URLike<U64, _LowerArithmeticRangeAndPrecisionViolation>
        : T2 extends I8      ? URLike<U64, _LowerArithmeticRangeViolation>
        : T2 extends I16     ? URLike<U64, _LowerArithmeticRangeViolation>
        : T2 extends I32     ? URLike<U64, _LowerArithmeticRangeViolation>
        : T2 extends I64     ? URLike<U64, _LowerArithmeticRangeViolation>
        : T2 extends I128    ? URLike<U64, _ArithmeticRangeViolation>
        : T2 extends I256    ? URLike<U64, _ArithmeticRangeViolation>
        : T2 extends I       ? URLike<U64, _ArithmeticRangeViolation>
        : T2 extends U8      ? U64
        : T2 extends U16     ? U64
        : T2 extends U32     ? U64
        : T2 extends U64     ? U64
        : T2 extends U128    ? URLike<U64, _UpperArithmeticRangeViolation>
        : T2 extends U256    ? URLike<U64, _UpperArithmeticRangeViolation>
        : T2 extends U       ? URLike<U64, _UpperArithmeticRangeViolation>
        : never :
    T1 extends U128
        ? T2 extends number  ? URLike<U128, _ArithmeticRangeAndPrecisionViolation>
        : T2 extends bigint  ? URLike<U128, _ArithmeticRangeViolation>
        : T2 extends Float   ? URLike<U128, _LowerArithmeticRangeAndPrecisionViolation>
        : T2 extends I8      ? URLike<U128, _LowerArithmeticRangeViolation>
        : T2 extends I16     ? URLike<U128, _LowerArithmeticRangeViolation>
        : T2 extends I32     ? URLike<U128, _LowerArithmeticRangeViolation>
        : T2 extends I64     ? URLike<U128, _LowerArithmeticRangeViolation>
        : T2 extends I128    ? URLike<U128, _LowerArithmeticRangeViolation>
        : T2 extends I256    ? URLike<U128, _ArithmeticRangeViolation>
        : T2 extends I       ? URLike<U128, _ArithmeticRangeViolation>
        : T2 extends U8      ? U128
        : T2 extends U16     ? U128
        : T2 extends U32     ? U128
        : T2 extends U64     ? U128
        : T2 extends U128    ? U128
        : T2 extends U256    ? URLike<U128, _UpperArithmeticRangeViolation>
        : T2 extends U       ? URLike<U128, _UpperArithmeticRangeViolation>
        : never :
    T1 extends U256
        ? T2 extends number  ? URLike<U256, _ArithmeticRangeAndPrecisionViolation>
        : T2 extends bigint  ? URLike<U256, _ArithmeticRangeViolation>
        : T2 extends Float   ? URLike<U256, _LowerArithmeticRangeAndPrecisionViolation>
        : T2 extends I8      ? URLike<U256, _LowerArithmeticRangeViolation>
        : T2 extends I16     ? URLike<U256, _LowerArithmeticRangeViolation>
        : T2 extends I32     ? URLike<U256, _LowerArithmeticRangeViolation>
        : T2 extends I64     ? URLike<U256, _LowerArithmeticRangeViolation>
        : T2 extends I128    ? URLike<U256, _LowerArithmeticRangeViolation>
        : T2 extends I256    ? URLike<U256, _LowerArithmeticRangeViolation>
        : T2 extends I       ? URLike<U256, _ArithmeticRangeViolation>
        : T2 extends U8      ? U256
        : T2 extends U16     ? U256
        : T2 extends U32     ? U256
        : T2 extends U64     ? U256
        ...
        : T2 extends U       ? URLike<U256, _UpperArithmeticRangeViolation>
        : never :
    T1 extends U
        ? T2 extends number  ? URLike<U, _ArithmeticRangeAndPrecisionViolation>
        : T2 extends bigint  ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends Float   ? URLike<U, _LowerArithmeticRangeAndPrecisionViolation>
        : T2 extends I8      ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends I16     ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends I32     ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends I64     ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends I128    ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends I256    ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends I       ? URLike<U, _LowerArithmeticRangeViolation>
        : T2 extends U8      ? U
        : T2 extends U16     ? U
        : T2 extends U32     ? U
        : T2 extends U64     ? U
...
export type U8 =
    & ULike<"U8"> 
    & {
    eq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    lt<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gt<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U8, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U8, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U8, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U8, T1, _DivisionByZero>;
};
...
export type U16 =
    ...
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U16, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U16, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U16, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U16, T1, _DivisionByZero>;
};
...
export type U32 =
    ...
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U32, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U32, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U32, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U32, T1, _DivisionByZero>;
};
...
export type U64 =
    ...
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U64, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U64, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U64, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U64, T1, _DivisionByZero>;
};
...
export type U128 =
    ...
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U128, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U128, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U128, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U128, T1, _DivisionByZero>;
};
...
export type U256 =
    ...
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U256, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U256, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U256, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U256, T1, _DivisionByZero>;
};
...
export type U =
    ...
    lteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    gteq<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): boolean;
    add<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U, T1, _UpperArithmeticRangeViolation>;
    sub<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U, T1, _LowerArithmeticRangeViolation>;
    mul<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U, T1, _UpperArithmeticRangeViolation>;
    div<T1 extends ULike<T2>, T2 extends ULikeBrand = ULikeBrandMap<T1>>(x: T1): LargestUR<U, T1, _DivisionByZero>;
};

export function U8<T1 extends NumberLike>(_x: NumberLike): URMap<U8, T1> {}

export function U16<T1 extends NumberLike>(_x: NumberLike): URMap<U16, T1> {}

export function U32<T1 extends NumberLike>(_x: NumberLike): URMap<U32, T1> {}

export function U64<T1 extends NumberLike>(_x: NumberLike): URMap<U64, T1> {}

export function U128<T1 extends NumberLike>(_x: NumberLike): URMap<U128, T1> {}

export function U256<T1 extends NumberLike>(_x: NumberLike): URMap<U256, T1> {}

export function U<T1 extends NumberLike>(_x: NumberLike): URMap<U, T1> {}
