...
export type SignedIntegerResultMap<T1 extends SignedInteger, T2 extends Numeric> =
    T1 extends I8
    ...
    T1 extends I64
        ...
        : T2 extends U128    ? SignedIntegerResult<I64, MathViolation.ArithmeticRange>
        : T2 extends U256    ? SignedIntegerResult<I64, MathViolation.ArithmeticRange>
        : T2 extends U       ? SignedIntegerResult<I64, MathViolation.ArithmeticRange>
        : never :
    T1 extends I128
