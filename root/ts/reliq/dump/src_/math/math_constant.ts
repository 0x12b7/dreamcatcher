...
export const MIN_128: bigint = -MIN_256;
...
export const MAX_U_32: U32 = U32(MAX_32).expect("Invalid maximum I32 constant." + INTERNAL_ERROR_MESSAGE);
...
export const MIN_U_8: U8 = U8(MIN_8).expect("Invalid minimum U8 constant." + INTERNAL_ERROR_MESSAGE);
export const MAX_NUMBER: number = Number.MAX_SAFE_INTEGER; ///  2**53 - 1
export const MIN_NUMBER: number = Number.MIN_SAFE_INTEGER; /// -2**53 - 1
